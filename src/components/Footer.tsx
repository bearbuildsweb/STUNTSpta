    ...
    <footer className="bg-zinc-100 text-neutral-800 border-t border-zinc-200 pt-16 pb-8 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-12 border-b border-zinc-200">
          ...
          {/* Brand/About Block */}
          <div className="md:col-span-4 space-y-6 text-left flex flex-col items-start">
            <div className="flex items-center gap-2 cursor-pointer flex-row" onClick={() => scrollToSection('hero')}>
            ...
            <div className="space-y-3 font-mono text-[11px] text-zinc-650 flex flex-col items-start w-full">
